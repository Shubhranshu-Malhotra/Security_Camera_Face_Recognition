...
# 	help="path to input feed")
ap.add_argument("-d", "--detector", type=str,
	default="face_detector",
	help="path to face detector model directory")
ap.add_argument("-c", "--confidence", type=float, default=0.5,
	help="minimum probability to filter weak detections")
ap.add_argument("-r", "--recognizer", type=str, required=True,
	help="path to trained recognizer")
ap.add_argument("-le", "--label_encoder", type=str, required = True,
	help="path to fit label encoder")
...
# python lbp_face_recog_video.py --input 0 -d face_detector 
# -r "D:/Projects/security_camera_face_recognition/Security_Camera_Face_Recognition/face_recognition/LBP_face_recog/output/recognizer.yml" 
# -le "D:/Projects/security_camera_face_recognition/Security_Camera_Face_Recognition/face_recognition/LBP_face_recog/output/label_encoder.pickle"